...
export const SETTINGS_SCHEMA = {
  ...
  shellEnhancementEnabled: {
    type: 'boolean',
    label: 'Shell Enhancement Enabled',
    category: 'Advanced',
    requiresRestart: false,
    default: true,
    description:
  ...
  shellSyntaxHighlighting: {
    type: 'boolean',
    label: 'Shell Syntax Highlighting',
    category: 'Advanced',
    requiresRestart: false,
    default: true,
    description: 'Enable zsh-syntax-highlighting in shell mode.',
    showInDialog: true,
  },
  shellAutosuggestions: {
    ...
    requiresRestart: false,
    default: true,
    description: 'Enable zsh-autosuggestions in shell mode.',
    showInDialog: true,
  },
  shellAiSuggestions: {
    type: 'boolean',
    ...
    requiresRestart: false,
    default: true,
    description: 'Enable AI-powered command suggestions and error handling.',
    showInDialog: true,
  },
  disableUpdateNag: {
    type: 'boolean',
